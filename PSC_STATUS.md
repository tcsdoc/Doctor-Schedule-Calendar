...
| **Active dev branch** | **`v4.4-dev`** — **All 5 phases complete** (July 4, 2026); 19 unit tests green; build 4.4 (4) awaiting device install/verification. `main` stays untouched as working backup |
